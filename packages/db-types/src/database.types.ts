...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      cardio_interval_type: "warmup" | "work" | "rest" | "cooldown" | "split" | "steady";
      circuit_format: "amrap" | "emom" | "for_time" | "rounds" | "interval" | "chipper" | "custom";
      distance_unit: "km" | "m" | "mi" | "floors" | "steps";
      import_batch_status: "running" | "completed" | "failed";
      import_review_status:
        "pending" | "parsed" | "review_required" | "approved" | "applied" | "rejected" | "failed";
